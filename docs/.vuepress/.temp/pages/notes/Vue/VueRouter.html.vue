...
<!-- ![img_7.png](img_7.png) -->
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>  <span class="token comment">// 在movie组件中希望根据id的值展示对应电影的信息</span>
  <span class="token punctuation">{</span>
