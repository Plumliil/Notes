...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-44c43e89-HAFSACBB.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-46a15f6f-ZR7BQHPW.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-8e52592d-KU33GV5J.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-20cc9db4-R3PAWX64.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-0a645df6-ZXC5MKEJ.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-04e74c0a-PWVSWSHC.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-db1a8a21-PD467SBR.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-b9649942-5ZSEROXJ.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-446df3e4-54DSRRF4.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-634fc78b-5LPUKMUO.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-72bddc41-LUSF2F7P.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-d53d2428-VQVG5OB5.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-9765461d-RUJHDUKG.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-d38aa57d-6ZEWXUBM.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-a44a74cb-2S5XPSVH.js");
...
var loader = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-65b51176-OQWDEGVA.js");
...
//# sourceMappingURL=chunk-Z2T7KN7H.js.map
