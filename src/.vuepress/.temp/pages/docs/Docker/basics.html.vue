...
<h4 id="镜像" tabindex="-1"><a class="header-anchor" href="#镜像" aria-hidden="true">#</a> 镜像</h4>
<p>镜像是一个只读的模板,可以用来创建容器</p>
<h4 id="容器" tabindex="-1"><a class="header-anchor" href="#容器" aria-hidden="true">#</a> 容器</h4>
<p>容器是docker的运行实例,提供了一个独立的可移植的环境,可以在环境中运行应用程序</p>
<p>镜像和容器的关系像是类和实例的关系</p>
<p>镜像是类</p>
<p>容器是实例</p>
<h5 id="容器化和dockerfile" tabindex="-1"><a class="header-anchor" href="#容器化和dockerfile" aria-hidden="true">#</a> 容器化和Dockerfile</h5>
...
<h4 id="仓库" tabindex="-1"><a class="header-anchor" href="#仓库" aria-hidden="true">#</a> 仓库</h4>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h2>
...
<li><code v-pre>docker build</code>: 这是构建Docker镜像的命</li>
<li><code v-pre>-t &lt;image-name&gt;:&lt;tag&gt;</code>: 指定构建后的镜像名称和标签。其中，<code v-pre>&lt;image-name&gt;</code>是您为镜像起的名称，<code v-pre>&lt;tag&gt;</code>是镜像的标签（如版本号），通常为latest或具体的版本号（如1.0.0）。如果省略标签，默认为latest。例如：-t my-app:latest。</li>
<li><code v-pre>-f &lt;Dockerfile-path&gt;</code>: （可选）指定Dockerfile的路径。如果Dockerfile位于当前目录下且名为&quot;Dockerfile&quot;，则可以省略此选项。否则，请提供Dockerfile的完整路径，如-f <code v-pre>/path/to/Dockerfile</code>。</li>
<li><code v-pre>&lt;context-path&gt;</code>: （可选）指定构建上下文的路径，即Docker将发送到守护进程进行构建的目录路径。守护进程会将该路径下的所有内容（包括子目录）打包成tar文件发送到服务器端。默认情况下，上下文路径是执行<code v-pre>docker build</code>命令时所在的目录。例如：.表示当前目录，<code v-pre>/path/to/context</code>表示指定的目录。</li>
</ul>
<h3 id="对镜像tag标记并容器转镜像" tabindex="-1"><a class="header-anchor" href="#对镜像tag标记并容器转镜像" aria-hidden="true">#</a> 对镜像tag标记并容器转镜像</h3>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>SOURCE_IMAGE[:TAG]：源镜像的名称和标签。如果不指定标签，默认为latest。</li>
<li>TARGET_IMAGE[:TAG]：目标镜像的名称和标签，可以是本地或远程仓库的镜像。</li>
</ul>
<p>示例：</p>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>或</p>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="在运行的容器中执行命令-docker-exec" tabindex="-1"><a class="header-anchor" href="#在运行的容器中执行命令-docker-exec" aria-hidden="true">#</a> 在运行的容器中执行命令 docker exec</h3>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>OPTIONS说明：</p>
<ul>
<li>-d :分离模式: 在后台运行</li>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a> </h2>
</div></template>
