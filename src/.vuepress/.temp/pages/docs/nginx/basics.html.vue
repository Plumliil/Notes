...
<p>以ubuntu为例</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic"># 1.安装前置依赖</span></span>
...
裹</p>
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #abb2bf"># 全局配置</span></span>
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #abb2bf"># 指定运⾏Nginx服务器的⽤户，只能在全局块配置</span></span>
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #abb2bf">events {</span></span>
...
<span class="line"><span style="color: #abb2bf">}</span></span>
<span class="line"><span style="color: #abb2bf"></span></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="http配置" tabindex="-1"><a class="header-anchor" href="#http配置" aria-hidden="true">#</a> http配置</h3>
<p>http块是配置⽂件的主要部分，包括http全局块和server</p>
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #abb2bf">http {</span></span>
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #abb2bf">server {</span></span>
...
<blockquote>
<p>Nginx官方文档
<a href="https://nginx.org/en/docs/" target="_blank" rel="noopener noreferrer">https://nginx.org/en/docs/<ExternalLinkIcon/></a></p>
</blockquote>
</div></template>
