...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建库" tabindex="-1"><a class="header-anchor" href="#创建库" aria-hidden="true">#</a> 创建库</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">--  普通创建库</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="删除库" tabindex="-1"><a class="header-anchor" href="#删除库" aria-hidden="true">#</a> 删除库</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #C678DD">DROP</span><span style="color: #ABB2BF"> </span><span style="color: #C678DD">DATABASE</span><span style="color: #ABB2BF"> 库名</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="创建表" tabindex="-1"><a class="header-anchor" href="#创建表" aria-hidden="true">#</a> 创建表</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- CREATE TABLE 表名 (</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #C678DD">DROP</span><span style="color: #ABB2BF"> </span><span style="color: #C678DD">TABLE</span><span style="color: #ABB2BF"> 表名;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="数据的增删改查" tabindex="-1"><a class="header-anchor" href="#数据的增删改查" aria-hidden="true">#</a> 数据的增删改查</h2>
<h3 id="增" tabindex="-1"><a class="header-anchor" href="#增" aria-hidden="true">#</a> 增</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- INSERT INTO 表名(字段1,字段2...) VALUES(值1,值2...)</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>需要注意的是字段名和字段值需一一对应</p>
<h3 id="删" tabindex="-1"><a class="header-anchor" href="#删" aria-hidden="true">#</a> 删</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- DELETE FROM 表名 WHERE 条件</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="改" tabindex="-1"><a class="header-anchor" href="#改" aria-hidden="true">#</a> 改</h3>
<p>算术运算符</p>
<ul>
<li>+</li>
<li>-</li>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- UPDATE 表名 SET 字段名1=字段值1,字段名2=字段值2... WHERE 条件</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="表的重命名" tabindex="-1"><a class="header-anchor" href="#表的重命名" aria-hidden="true">#</a> 表的重命名</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- RENAME TABLE 旧表名 TO 新表名;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="更新表字段" tabindex="-1"><a class="header-anchor" href="#更新表字段" aria-hidden="true">#</a> 更新表字段</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 新增表字段</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- SELECT 字段1,字段2... from 表名 [where 条件]</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 升序查成绩</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="sql-语句分类" tabindex="-1"><a class="header-anchor" href="#sql-语句分类" aria-hidden="true">#</a> SQL 语句分类</h4>
<ul>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- SHOW CREATE DATABASE 库名; 查询指定库信息</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="查询表" tabindex="-1"><a class="header-anchor" href="#查询表" aria-hidden="true">#</a> 查询表</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 查询当前库下表信息</span></span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic"># 备份</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 查询id为1,3的数据</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 查询goods表中商品种类</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="分页查询" tabindex="-1"><a class="header-anchor" href="#分页查询" aria-hidden="true">#</a> 分页查询</h3>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="多表查询" tabindex="-1"><a class="header-anchor" href="#多表查询" aria-hidden="true">#</a> 多表查询</h3>
<ul>
...
<p>部门表</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- amydb.dept definition</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>员工表</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- amydb.emp definition</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- select * from 表1,表2,...,表n where 条件</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1.查询部门编号为 1 的部门下所有的员工</p>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2.查询所有部门中的所有员工</p>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3.找出开发部中所有员工名以及薪资和部门名</p>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>4.找出开发部,测试部中所有员工名以及薪资和部门名</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 方式一</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.找出开发部中所有员工名以及薪资和部门名</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #C678DD">select</span><span style="color: #ABB2BF"> </span><span style="color: #D19A66">d</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">deptName</span><span style="color: #ABB2BF"> ,</span><span style="color: #D19A66">e</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">empName</span><span style="color: #ABB2BF"> ,</span><span style="color: #D19A66">e</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">salary</span></span>
<span class="line"><span style="color: #C678DD">from</span><span style="color: #ABB2BF"> dept d</span></span>
<span class="line"><span style="color: #C678DD">inner join</span><span style="color: #ABB2BF"> emp e</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="左外连接" tabindex="-1"><a class="header-anchor" href="#左外连接" aria-hidden="true">#</a> 左外连接</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 若此时没有员工属于销售部 则查到的empName 和 salary为null</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="右外连接" tabindex="-1"><a class="header-anchor" href="#右外连接" aria-hidden="true">#</a> 右外连接</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #C678DD">select</span><span style="color: #ABB2BF"> </span><span style="color: #D19A66">d</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">deptName</span><span style="color: #ABB2BF"> ,</span><span style="color: #D19A66">e</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">empName</span><span style="color: #ABB2BF"> ,</span><span style="color: #D19A66">e</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">salary</span></span>
...
<span class="line"><span style="color: #C678DD">on</span><span style="color: #ABB2BF"> </span><span style="color: #D19A66">d</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">id</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">=</span><span style="color: #D19A66">e</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">deptID</span><span style="color: #ABB2BF"> </span><span style="color: #C678DD">where</span><span style="color: #ABB2BF"> </span><span style="color: #D19A66">d</span><span style="color: #ABB2BF">.</span><span style="color: #D19A66">deptName</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">=</span><span style="color: #98C379">&#39;销售部&#39;</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="表设计以及三表查询" tabindex="-1"><a class="header-anchor" href="#表设计以及三表查询" aria-hidden="true">#</a> 表设计以及三表查询</h3>
<h4 id="示例一" tabindex="-1"><a class="header-anchor" href="#示例一" aria-hidden="true">#</a> 示例一</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 问题不确定</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 得到总分数</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- 购物车</span></span>
<span class="line"><span style="color: #7F848E; font-style: italic">--</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- DATA_FORMAT(data,format)</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="时间函数" tabindex="-1"><a class="header-anchor" href="#时间函数" aria-hidden="true">#</a> 时间函数</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #ABB2BF">  </span><span style="color: #C678DD">SELECT</span><span style="color: #ABB2BF"> 时间函数()</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- create view 视图名 as 查询语句</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查询某一视图中数据" tabindex="-1"><a class="header-anchor" href="#查询某一视图中数据" aria-hidden="true">#</a> 查询某一视图中数据</h3>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="删除视图中某一条数据" tabindex="-1"><a class="header-anchor" href="#删除视图中某一条数据" aria-hidden="true">#</a> 删除视图中某一条数据</h3>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="删除视图" tabindex="-1"><a class="header-anchor" href="#删除视图" aria-hidden="true">#</a> 删除视图</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #C678DD">delete</span><span style="color: #ABB2BF"> </span><span style="color: #C678DD">from</span><span style="color: #ABB2BF"> view_emp</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="向视图中插入一条数据" tabindex="-1"><a class="header-anchor" href="#向视图中插入一条数据" aria-hidden="true">#</a> 向视图中插入一条数据</h3>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="修改视图数据" tabindex="-1"><a class="header-anchor" href="#修改视图数据" aria-hidden="true">#</a> 修改视图数据</h3>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="应用场景" tabindex="-1"><a class="header-anchor" href="#应用场景" aria-hidden="true">#</a> 应用场景</h3>
<ul>
<li>金融行业</li>
<li>保险行业</li>
<li>财务行业</li>
...
<ul>
<li>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #ABB2BF">  </span><span style="color: #7F848E; font-style: italic">-- 5.0+</span></span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #C678DD">start transaction</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="存储过程" tabindex="-1"><a class="header-anchor" href="#存储过程" aria-hidden="true">#</a> 存储过程</h2>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">-- create procedure 存储过程名 (参数名1 参数类型1,参数名2 参数类型2)</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>MySQL 存储过程的优点包括减少网络流量、提高性能和安全性、封装复杂的业务逻辑等。存储过程还支持参数传递、条件判断、循环和异常处理等高级功能，可以根据具体的需求进行编写和使用。类似于函数的调用</p>
<h4 id="带返回值的储存过程" tabindex="-1"><a class="header-anchor" href="#带返回值的储存过程" aria-hidden="true">#</a> 带返回值的储存过程</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #ABB2BF">DELIMITER //</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="带-if-语句的存储过程" tabindex="-1"><a class="header-anchor" href="#带-if-语句的存储过程" aria-hidden="true">#</a> 带 if 语句的存储过程</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #ABB2BF">DELIMITER //</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="存储过程之-case" tabindex="-1"><a class="header-anchor" href="#存储过程之-case" aria-hidden="true">#</a> 存储过程之 Case</h3>
